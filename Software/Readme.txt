Introduction:
1.The software CarSPred 2.0 could be used to identify carbonylation sites of query human protein sequences.
...
5.The software is in 'CarSPred-2.0' folder. Datasets of carbonylated protein and sample sequences of carbonylation site are in 'Datasets' folder.
...
For details, refer to the manual coming with the software CarSPred 2.0.
