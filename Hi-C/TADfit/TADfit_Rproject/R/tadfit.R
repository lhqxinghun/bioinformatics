tadfit <- function(matlistcon1=NULL, matlistcon2=NULL, namecon1="Context1", namecon2="Context2", 
                   ...
                   parhierTADs=list(winsize=5, bstatfilter=TRUE, bTADsfilter=TRUE, bPSSM = FALSE, minsizescale=0.01, maxsizescale=0.5), parFTRLreg=list(repeatnum=3, iteration=2, lambda=0.1, alpha=c(0.0025,0.005,0.010), beta=c(1,1,1), l1=c(0.5,1,2), l2=c(0.5,1,2)))
{
