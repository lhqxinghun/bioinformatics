calltad <- function(dirin, resolution, start, end, species = "hg19",  chr = "chr1", winsize = 5, minisizescale = 0.01, maxsizescale = 0.5, repeatnum = 5, iteration = 5, alpha = 0.01, beta = 1, l = 2, bPSSM = FALSE)
{
  ...
  parhierTADs=list(winsize=winsize, bstatfilter=TRUE, bTADsfilter=TRUE, bPSSM = bPSSM, minsizescale=minisizescale, maxsizescale=maxsizescale)
