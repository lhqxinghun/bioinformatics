...
public:
    ...
    void findiagcpbyTopDom_gmean(std::vector<contactmatrix> &sourdataset, int winsize, bool bstatFilter, std::vector<changepoint> &diagcp);
    void findiagcpbyTopDom_pssm(std::vector<contactmatrix> &sourdataset, int winsize, bool bstatFilter, std::vector<changepoint> &diagcp);
    ...
    void ftrlsolver(std::vector<contactmatrix> &sourdataset, std::vector<contactdomain> &hiercd, std::vector<double> &regevar2,int repeatnum, int iteration, double lambda, double alpha, double beta, double l1, double l2);
...
private:
    ...
    void diagcptobasecp(std::vector<std::vector<changepoint> *> &diagcp, int width, int height, std::vector<int> &basecp);
